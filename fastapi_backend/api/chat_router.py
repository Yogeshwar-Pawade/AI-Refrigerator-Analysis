...
@router.get("/chat/conversations/{diagnosis_id}", response_model=List[ChatConversation])
async def get_chat_conversations(diagnosis_id: str):
    """Get all conversations for a refrigerator diagnosis"""
    return await get_conversations(diagnosis_id)
